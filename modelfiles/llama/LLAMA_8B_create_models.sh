...
ollama create LLAMA_8b_LLM_resumen_NO_RAG_T1 -f ./llama/LLAMA_8b_LLM_resumir_NO_RAG_T1.txt
ollama create LLAMA_8b_LLM_resumen_NO_RAG_T2 -f ./llama/LLAMA_8b_LLM_resumir_NO_RAG_T2.txt
ollama create LLAMA_8b_LLM_resumen_NO_RAG_T3 -f ./llama/LLAMA_8b_LLM_resumir_NO_RAG_T3.txt
